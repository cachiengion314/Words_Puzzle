...
public class WeekenSaleDialog : Dialog
{
    public TextMeshProUGUI numRubyTexts;
    public TextMeshProUGUI priceText, saleText, priceOriginText;
    ...
    protected override void Start()
    {
        ...
        priceText.text = Purchaser.instance.iapItems[_indexIAPItem].price + "$";
        priceOriginText.text = (Purchaser.instance.iapItems[_indexIAPItem].price / 0.8f) + "$";
        saleText.text = Purchaser.instance.iapItems[_indexIAPItem].txtSale;
#endif
    }
