...
public class LineDrawer : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else if (Input.GetMouseButtonUp(0))
        {
            ...
            if (WordRegion.instance.CurLevel >= TutorialController.instance.bonusBoxLevel && !TutorialController.instance.isTutFlag && !CPlayerPrefs.HasKey("TUT_EXTRA_WORD") && WordRegion.instance.Lines.Any(li => li.isShown) && TutorialController.instance.isShowTut && WordRegion.instance.Lines.Find(lineWord => lineWord.answers.Count > 1) != null)
            {
