...
public class Pan : MonoBehaviour
{
    ...
    public void Shuffle()
    {
        ...
        tweenControl.LocalRotate(centerPoint, new Vector3(0, 0, 360), 0.3f/*);tweenControl.ScaleFromOne(centerPoint.gameObject, 0.3f*/, () =>
        {
            ...
            {
                tweenControl.LocalRotate(centerPoint, new Vector3(0, 0, centerPoint.localRotation.z + 360), 0.1f/*);tweenControl.ScaleFromZero(centerPoint.gameObject, 0.3f*/, () =>
                {
        ...
        foreach (var text in letterTexts)
        {
            ...
            {
                tweenControl.LocalRotate(text.transform, new Vector3(0, 0, (text.transform.localPosition.z + 360f * 2)), 0.1f, () =>
                {
            ...
            tweenControl.MoveLocal(text.transform, /*oldPos / 3.5f*/Vector3.zero, 0.3f, () =>
                 {
                     ...
                     tweenControl.DelayCall(transform, 0.15f, () =>
                     {
                         ...
                         tweenControl.MoveLocal(text.transform, oldPos, 0.1f);
                     });
                 });
