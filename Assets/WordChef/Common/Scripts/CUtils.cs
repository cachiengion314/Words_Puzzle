...
public class CUtils
{
    ...
    public static void SetRunVipPack()
    {
        if (!CPlayerPrefs.HasKey("vip_pack_started"))
        {
            CPlayerPrefs.SetBool("vip_pack_started", true);
            long span = (long)DateTime.Now.Subtract(new DateTime(1970, 1, 1, 0, 0, 0)).TotalSeconds;
            CPlayerPrefs.SetLong("time_vip_pack_started", span);
        }
    }

    public static long GetTimeVipPackStarted()
    {
        return CPlayerPrefs.GetLong("time_vip_pack_started");
    }

    public static void SetBuyVipPack(int index)
    {
        CPlayerPrefs.SetBool("buy_vip_pack_" + index, true);
    }

    public static void SetRemoveAds()
    {
        CPlayerPrefs.SetBool("remove_ads", true);
    }
    ...
    public static bool IsBuyVipPack(int index)
    {
        return CPlayerPrefs.GetBool("buy_vip_pack_" + index, false);
    }
